...
class PinSuccessPage extends GetView<PinSuccessController> {
        ...
        body: SizedBox(
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  _buildPinSuccessInfo(),
                  _buildPinSuccessInfoEx(),
                  SizedBox(
                    height: 10.h,
                  ),
                  Divider(
  ...
  Widget _buildButtons() {
    return Column(children: <Widget>[
      ...
      ElevatedButton(
        ...
        onPressed: () {
          //Get.toNamed(AppRoutes.PinSuccess);
        },
        child: Text(
          'HOME',
          style: TextStyle(
