...
class AppColors {
  ...
  static const Color comboTitleText = Color.fromARGB(255, 255, 87, 51);

  // *****************************************

  /// 第三种控件-背景色 石墨色
  static const Color thirdElement = Color.fromARGB(255, 238, 238, 238);

  /// 第三种控件-文本 浅灰色2
  static const Color thirdElementText = Color.fromARGB(255, 153, 153, 153);
  ...
  static const Color tabBarElementActive = Color.fromARGB(255, 255, 195, 0);

  /// tabCellSeparator 单元格底部分隔条 颜色
  static const Color tabCellSeparator = Color.fromARGB(255, 230, 230, 231);

  static const Color bigButton = Color.fromARGB(255, 255, 87, 51);

  static const Color AppBar = Color.fromARGB(255, 196, 90, 90);
}
